...
class LibtoolImporter(object):
    ...
    def load_module(self, name):
        ...
        # The first item of the suffix tuple (which can be, depending on
        # platform, one or more valid filename extensions used to name c
        # extension modules) is ignored by the imp_load_module() implementation
        # in Python/import.c for Python 2.5, 2.6 and 2.7.
        # Thus, there is no use in pretending it is important and we set it
        # to an empty string.
