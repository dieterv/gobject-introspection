...
#
# Imported from:
#   https://dxr.mozilla.org/mozilla-central/source/python/mozbuild/mozbuild/preprocessor.py
"""
...
if sys.platform == "win32" and not 'MINGW' in os.environ.get('MSYSTEM'):
    import msvcrt
...
class Preprocessor:
    ...
    def getCommandLineParser(self, unescapeDefines = False):
        ...
        p.add_option('--line-endings', action='callback', callback=handleLE,
                     type="string", metavar="[cr|lf|crlf]",
